...
import UIKit
import Firebase
class SetBioViewController: UIViewController, UITextViewDelegate {
    ...
    func uploadToDatabase() {
        ...
        if bioTextField.text != nil {
            ...
            value.updateValue(firebaseString, forKey: "Bio")
        }
    ...
    override func viewDidLoad() {
        ...
        bioTextField.text = "Please enter a short (175-Character Max) bio..."
